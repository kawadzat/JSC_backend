...
public class SecureCapitaApplication {
	...
	public CorsFilter corsFilter() {
		...
		corsConfiguration.setAllowedOrigins(List.of("https://processmanagement.tanawellnesscoaching.com","http://localhost:4200", "http://localhost:3000", "http://securecapita.org"));
