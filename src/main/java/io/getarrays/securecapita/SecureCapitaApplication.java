...
public class SecureCapitaApplication {
	...
	public CorsFilter corsFilter() {
		...
		corsConfiguration.setAllowedOrigins(List.of("https://processmanagement.tanawellnesscoaching.com","https://processafr.com","http://localhost:4200", "http://localhost:3000", "http://securecapita.org"));
